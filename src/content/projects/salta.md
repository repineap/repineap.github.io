...
of all of your sources so that you can easy synthesize information together.
...
There a few basic building blocks that come together to create a very nice experience.

### Tauri App

The actual app interface is powered by tauri, a more modern rust based native application system.
Built out of a simple typescript frontend and extensive rust backend, it is a very quick application
...
I will talk more about the parsing pipeline, but one the coolest features I have shipped with Salta is the ability
...
This kind of extensibility makes it easily adapt to different peoples' workflows and specific use cases which all
parse down to the same markdown that can easily be shared between team members and to agents.

## The Parsing Pipeline

As mention above the parsing takes a few steps that I would love to explain.
...
When a new document arrives a local embedding modal scans it and tries to classify it into one of your predefined categories
